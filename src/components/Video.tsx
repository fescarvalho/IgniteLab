      ...
      <div className="p-8 max-w-[1100px] mx-auto">
        <div className="flex items-start gap-16">
          <div className="flex-1">
            <h1 className="text-2-xl font-bold ">Aula 01 - Criando o projeto e realizando o setup inicial</h1>
          ...
          <div className="flex items-center gap-4 mt-6">
            <img 
              ...
              src="https://github.com/fescarvalho.png" 
              alt="" />
            <div className="leading-relaxed">
              <strong className="font-bold text-2-xl block">Fernando Carvalho</strong>
